...
const Coupons = () => {
    ...
    const { coupons, isLoading, isError, message, isSuccess } = useSelector(
        (state) => state.coupons
    );
    ...
    }, [isError, isSuccess, message, dispatch, closeModal]);
    ...
    const onSubmit = (e) => {
        ...
        const couponData = {
            ...
            isActive,
            applicableFor: validApplicableFor[applicableFor] || "all",
        };
